    ...
    if update.effective_chat.type == "private":
        ...
        update.effective_message.reply_photo(
            ...
            reply_markup=InlineKeyboardMarkup(
              [
                [[InlineKeyboardButton(text="Support", url="t.me/KazukoSupportChat"), InlineKeyboardButton(text="Updates", url="t.me/KazukoUpdates",
                  ),
              ],
                  InlineKeyboardButton(text="Try Inline",switch_inline_query_current_chat="")]]
            ),
...
or choosing help button at home menu and report error/bugs at Kazuko's support chat...""",
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            text=" Setup Guide ", url="https://t.me/KazukoUpdates/7",
                        ),
