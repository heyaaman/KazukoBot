...
from KazukoBot import CMD_LIST, LOAD_PLUG, MONGO_DB_URI, tbot, telethn, ubot
...
def load_module(shortname):
    if shortname.startswith("__"):
        ...
        path = Path(f"KazukoBot/advanced/{shortname}.py")
        name = "KazukoBot.advanced.{}".format(shortname)
