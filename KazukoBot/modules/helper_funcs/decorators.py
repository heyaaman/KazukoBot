...
class KigyoTelegramHandler:
    ...
    def command(
        self, command: str, filters: BaseFilter = None, admin_ok: bool = False, pass_args: bool = False, pass_chat_data: bool = False, run_async: bool = True, can_disable: bool = True, group: int = 40
    ):
    ...
    def inlinequery(self, pattern: str = None, run_async: bool = True, pass_user_data: bool = True, pass_chat_data: bool = True, chat_types: str = None):
        def _inlinequery(func):
            ...
            log.debug(f'[run_async] Loaded inlinequery handler with pattern {pattern} for function {func.__name__} | PASSES USER DATA: {pass_user_data} | PASSES CHAT DATA: {pass_chat_data} | CHAT TYPES: {chat_types}')
            return func
        return _inlinequery
