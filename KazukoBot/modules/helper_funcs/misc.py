...
def paginate_modules(page_n: int, module_dict: Dict, prefix, chat=None) -> List:
    ...
    if calc in [1, 2]:
        ...
        pairs += [[ EqInlineKeyboardButton("Home", callback_data="kazuko_back"), EqInlineKeyboardButton("Setup Guide", url="https://t.me/KazukoUpdates/22"), EqInlineKeyboardButton(text="Try inline",switch_inline_query_current_chat=""), ]]
    return pairs
