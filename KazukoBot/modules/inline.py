...
def inlinequery(update: Update, _) -> None:
    ...
    inline_help_dicts = [
        ...
        {
            "title": "Account info on Kazuko",
            "description": "Look up a Telegram account in Kazuko database",
            "message_text": "Click the button below to look up a person in Kazuko database using their Telegram ID",
            "thumb_urL": "https://telegra.ph/file/9cd450abab6160b9f9b56.jpg",
            "keyboard": ".info ",
        },
        {
            "title": "About",
            "description": "Know about Kazuko",
            "message_text": "Click the button below to get to know about Kazuko.",
            "thumb_urL": "https://telegra.ph/file/9cd450abab6160b9f9b56.jpg",
            "keyboard": ".about ",
        },
        {
...
def about(query: str, update: Update, context: CallbackContext) -> None:
    ...
    sql.update_user(user.id, user.username)
    about_text = f"""
    Kazuko (@{context.bot.username})
    Maintained by [heyaaman](t.me/heyaaman)
    ...
    kb = InlineKeyboardMarkup(
        [
            [
                ...
                InlineKeyboardButton(
                    text="Channel",
                    url=f"https://t.me/PHOENIX_EMPIRE",
                ),
                InlineKeyboardButton(
                    text='Ping',
            ...
            [
                InlineKeyboardButton(
                    text="GitHub",
                    url="https://www.github.com/heyaaman/KazukoBot",
                ),
            ],
        ])
