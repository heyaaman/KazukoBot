...
@run_async(command='echo', pass_args=True, filters=Filters.chat_type.groups)
@user_admin
...
@run_async(command='markdownhelp', filters=Filters.chat_type.private)
...
stats_str = '''
'''
@run_async(command='stats', can_disable=False)
@sudo_plus
